...
public class GramDecoder {
    ...
    public static final int ADJECT = 2; // прилаг, счетн числ, причастие,
                                        // мест-прилаг
    public static final int ADVERB = 3;// наречие, дееприч
    public static final int NUMER = 4; // числит
    public static final int FUNC = 5; // служебное слово (предл, союз, межд,
                                      // част, вводн)
    public static final int[] allParts = { NOUN, VERB, ADJECT, ADVERB, NUMER,
            FUNC };// number
