...
//    private static final int endShift = 0;
     ...
     * @param dl расстояние в буквах
     * @param dl2 расстояние в буквах, перестановка символов считается элементарной ред. операцией

     * @return код параметров паронимического отношения.
     * В случае, если dl и dm одновременно равны -1, возвращается код 0.
     * @throws ParonymCodeException Недопустимые значения параметров.
     */
    public static byte generateDlCode(int dl, int dl2) throws ParonymCodeException {
       ...
       try {
           ...
           return Byte.valueOf(code, 2);
            ...
            throw new ParonymCodeException("Could not generate Paronym Code. " + e.getMessage());
        }
    }

    /**
    * @param dm  расстояние в морфах
     * @param dr  расстояние в буквах между корнями
     * @param pref различие в приставках
     * @param root различие в приставках
     * @param relRoots корни являются чередующими
     * @param suff различие в суффиксах
     * @param end различие в окончаниях
     * @return
     * @throws ParonymCodeException
     */
    public static int generateDmCode
               (int dm, int dr, boolean pref, boolean root, boolean relRoots, boolean suff, boolean end)
               throws ParonymCodeException {
        // dm 0-15
        // dr 0-15
