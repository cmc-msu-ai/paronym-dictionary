...
public class QueryParameters {
    ...
    public boolean includeNotFound; // включать слова, не распознанные морф.
                                    // анализатором
    public boolean enablePlural;
    public int setPart;

    public QueryParameters(int maxdl, int maxdm, int maxdr, double q,
            boolean enableForms, boolean part, boolean gen, boolean num,
            boolean relativeRoots, boolean diffPref, boolean diffRoot,
            boolean diffSuff, boolean diffEnding, boolean enableDl2,
            boolean includeNotFound, boolean enablePlural, int setPart) {
        this.maxdl = maxdl;
        this.maxdm = maxdm;
        this.maxdr = maxdr;
        this.q = q;
